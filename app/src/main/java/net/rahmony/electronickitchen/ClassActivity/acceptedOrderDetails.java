...
public class acceptedOrderDetails extends AppCompatActivity {
    ...
    ListView mListView_accepted_order_details;
    ...
    protected void onResume() {
         ...
         */
        //implement List View.
        mListView_accepted_order_details= (ListView) findViewById(R.id.listView_accepted_order_details);
        ...
        //Start Call.
        Call<List<Cart>> callOrderDetails = apiService.acceptedOrderDetails(cart);
        callOrderDetails.enqueue(new Callback<List<Cart>>() {
            ...
            public void onResponse(Response<List<Cart>> response, Retrofit retrofit) {
                ...
                if (response.message().equalsIgnoreCase("ok")) {
                    ...
                    mListView_accepted_order_details.setAdapter(arr);
                }
            }
    ...
    public void onClick(View v) throws IOException {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_accepted_order_details_ready_order:

                //Set Invoice_ID in Cart
                cart.setInvoice_ID(extra.getInt("Invoice_ID"));

                //Start Call
                Call<Cart> callAcceptOrder  = apiService.readyForDelivery(cart);
    ...
    private class myAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View v = inflater.inflate(R.layout.list_accepted_order_details, parent, false);

            TextView mText_list_order_details_ProductName = (TextView) v.findViewById(R.id.text_list_accepted_order_details_ProductName);
            mText_list_order_details_ProductName.setText(list_productName.get(position).toString());

            TextView mText_list_order_details_Price = (TextView) v.findViewById(R.id.text_list_accepted_order_details_Price);
            mText_list_order_details_Price.setText(list_Price.get(position).toString());

            TextView mText_list_order_details_Quantity = (TextView) v.findViewById(R.id.text_list_accepted_order_details_Quantity);
